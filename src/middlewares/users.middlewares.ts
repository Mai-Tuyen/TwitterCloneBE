...
export const loginValidator = validate(
  checkSchema({
    email: {
      ...
      trim: true,
      custom: {
        // add to request controller user login info
...
// headers is location Where checkSchema check
  ...
  checkSchema(
    {
      name: {
        ...nameSchema,
        optional: true,
        notEmpty: undefined // override notEmpty trong nameSchema
      },
      date_of_birth: {
        ...dateOfBirthSchema,
        optional: true
      ...
      username: {
        ...
        trim: true, // chú ý để trim dưới isString
        custom: {
          options: async (value: string, { req }) => {
